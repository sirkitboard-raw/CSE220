...
.text	
	...
	#-------------------------------Print Exponent------------------------------
	#---------------------------------------------------------------------------
	# Prints the Exponent part of the float in Binary
	# Arguments : $f12, Masked Float containing only the Exponent
	#---------------------------------------------------------------------------
	printExponent:
		add $t2, $zero,$a0
		li $t3, 0x00000080
	...
	#-------------------------------Print Fraction------------------------------
	#---------------------------------------------------------------------------
	# Prints the fractional part of the Function in Binary
	# Arguments : $f12, Masked Float containing only the Exponent
	#---------------------------------------------------------------------------
  	printFraction:
		add $t2, $zero,$a0
	...
	#-------------------------------Print Mantissa------------------------------
	#---------------------------------------------------------------------------
	# Prints the Mantissa in general form
	# Arguments : $f12, Masked Float containing only the Exponent
	#---------------------------------------------------------------------------
  	printMantissa:
  		add $t2, $zero,$a0
	...
	#---------------------------------------------------------------------------
	# Compares 2 strings
	# Arguments : $a0, The first string to be compared
	# 	      $a1, The second String to be compared
	# Return: $v0, 0 if equal, 1 if not equal
	#---------------------------------------------------------------------------
	compareStrings:
		add $t0, $zero, $zero
		add $t1, $zero, $a0
